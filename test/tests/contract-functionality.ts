...
import contract, {Table, TableRowCursor} from '@wharfkit/contract'

const client = makeClient('https://eos.greymass.com')
const rewardsContract = new RewardsGm.Contract({client})
const msigContract = new EosioMsig.Contract({client})
    ...
    suite('Contract', function () {
        ...
        suite('retrieve table', function () {
            ...
            test('eosio.msig tables', async function () {
                ...
                // Test proposal table
                const proposalTable = msigContract.table('proposal', 'eosio.msig')
