...
export namespace ActionParams {
    ...
    export interface Createcol {
        ...
        data: Types.PairStringATOMICATTRIBUTE[]
    }
    ...
    export interface Createtempl {
        ...
        immutable_data: Types.PairStringATOMICATTRIBUTE[]
    }
    ...
    export interface Logburnasset {
        ...
        old_immutable_data: Types.PairStringATOMICATTRIBUTE[]
        old_mutable_data: Types.PairStringATOMICATTRIBUTE[]
    ...
    export interface Logmint {
        ...
        immutable_data: Types.PairStringATOMICATTRIBUTE[]
        mutable_data: Types.PairStringATOMICATTRIBUTE[]
        backed_tokens: AssetType[]
        immutable_template_data: Types.PairStringATOMICATTRIBUTE[]
    }
    ...
    export interface Logsetdata {
        asset_owner: NameType
        asset_id: UInt64Type
        old_data: Types.PairStringATOMICATTRIBUTE[]
        new_data: Types.PairStringATOMICATTRIBUTE[]
    }
    ...
    export interface Setassetdata {
        ...
        asset_owner: NameType
        asset_id: UInt64Type
        new_mutable_data: Types.PairStringATOMICATTRIBUTE[]
    }
...
export namespace Types {
    ...
    export class AssetsS extends Struct {
        @Struct.field(UInt64)
        asset_id!: UInt64
        @Struct.field(Name)
        collection_name!: Name
    ...
    export class BalancesS extends Struct {
        @Struct.field(Name)
        owner!: Name
        @Struct.field(Asset, {array: true})
        quantities!: Asset[]
    ...
    export class CollectionsS extends Struct {
        @Struct.field(Name)
        collection_name!: Name
        @Struct.field(Name)
        author!: Name
    ...
    export class OffersS extends Struct {
        @Struct.field(UInt64)
        offer_id!: UInt64
        @Struct.field(Name)
        sender!: Name
    ...
    export class SchemasS extends Struct {
        @Struct.field(Name)
        schema_name!: Name
        @Struct.field(FORMAT, {array: true})
        format!: FORMAT[]
    ...
    export class TemplatesS extends Struct {
        @Struct.field(Int32)
        template_id!: Int32
        @Struct.field(Name)
        schema_name!: Name
    ...
    export class TokenconfigsS extends Struct {
        @Struct.field(Name)
        standard!: Name
        @Struct.field('string')
        version!: string
...
const TableMap = {
    assets: Types.AssetsS,
    balances: Types.BalancesS,
    collections: Types.CollectionsS,
    config: Types.ConfigS,
    offers: Types.OffersS,
    schemas: Types.SchemasS,
    templates: Types.TemplatesS,
    tokenconfigs: Types.TokenconfigsS,
}
