...
export namespace ActionParams {
    ...
    export interface addinventory {
        player: NameType
        ingredients: Base.pair_uint32_uint64
    }
    ...
    export interface doaddmats {
        ...
        materials: Base.pair_uint32_uint64
    }
    ...
    export interface setcrew {
        spaceship_id: UInt64Type
        crew: Base.pair_uint64_CrewRole
    }
