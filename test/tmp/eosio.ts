...
export namespace ActionParams {
    export namespace Types {
        ...
        export interface powerup_config_resource {
            ...
            target_timestamp: TimePointSecType
